...
proc get_encrypting_dict(self: var PlaintextMessage): Table[char, char] =
  self.encrypting_dict = self.build_shift_dict(self.shift)
  result = self.encrypting_dict

proc get_message_text_encrypted(self: var PlaintextMessage): string =
  self.message_text_encrypted = self.apply_shift(self.shift)
  result = self.message_text_encrypted

proc change_shift(self: var PlaintextMessage; shift: int) =
  #
